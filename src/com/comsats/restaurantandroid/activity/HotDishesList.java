...
public class HotDishesList extends ApplicationMenu implements TextWatcher {
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        top_bar.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				finish();
				Intent ourIntent = new Intent(HotDishesList.this, Order.class);
        		HotDishesList.this.startActivity(ourIntent);
			}
		});
        ...
        adapter = new DishListBaseAdapter(this, dish_details,"hot");
        
        headerTxt.setText("Hot Dishes");
        ...
        backBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				finish();
				Intent ourIntent = new Intent(HotDishesList.this, Home.class);
        		HotDishesList.this.startActivity(ourIntent);
			}
		});
        ...
        {
        	Toast.makeText(getApplicationContext(), "No Hot Dishes Found!", Toast.LENGTH_LONG).show();
        }
        ...
        dishesList.setOnItemClickListener(new OnItemClickListener() {
        	public void onItemClick(AdapterView<?> a, View v, int position, long id) {
    			...
    			basket.putString("checkDish", "hot");
        		...
        		Thread timer = new Thread()
        		{
        			public void run(){
        					try{
        						Intent ourIntent = new Intent(HotDishesList.this, Loading.class);
        		        		HotDishesList.this.startActivity(ourIntent);
        		        		sleep(1000);
								...
								try {
									...
									finish();
									Intent ourIntent = new Intent(HotDishesList.this, ourClass);
        ...
        searchDish.setHint("Search Hot Dish");
	...
	public ArrayList<DishDetails> GetSearchResults(){
    	...
    	String content = null;
		try {
			content = URLConnectionReader.getText(URLConnectionReader.getIP()+"get_all_hotdishes.jsp");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
