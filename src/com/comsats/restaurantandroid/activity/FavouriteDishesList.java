...
public class FavouriteDishesList extends ApplicationMenu implements TextWatcher{
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        top_bar.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				finish();
				Intent ourIntent = new Intent(FavouriteDishesList.this, Order.class);
				FavouriteDishesList.this.startActivity(ourIntent);
			}
		});
        ...
        adapter = new DishListBaseAdapter(this, dish_details,"fav");
        
        headerTxt.setText("Favourite Dishes");
        ...
        backBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				finish();
				Intent ourIntent = new Intent(FavouriteDishesList.this, Favourite.class);
				FavouriteDishesList.this.startActivity(ourIntent);
			}
		});
        homeBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				finish();
				Intent ourIntent = new Intent(FavouriteDishesList.this, Home.class);
				FavouriteDishesList.this.startActivity(ourIntent);
			}
		});
        ...
        {
        	Toast.makeText(getApplicationContext(), "No Favourite Dishes Found!", Toast.LENGTH_LONG).show();
        }
        ...
        dishesList.setOnItemClickListener(new OnItemClickListener() {
        	public void onItemClick(AdapterView<?> a, View v, int position, long id) {
    			...
    			basket.putString("checkDish", "fav");
        		...
        		Thread timer = new Thread()
        		{
        			public void run(){
        					try{
        						Intent ourIntent = new Intent(FavouriteDishesList.this, Loading.class);
        						FavouriteDishesList.this.startActivity(ourIntent);
        		        		sleep(1000);
								...
								try {
									...
									finish();
									Intent ourIntent = new Intent(FavouriteDishesList.this, ourClass);
	...
	public ArrayList<DishDetails> GetSearchResults(){
    	...
    	String content = null;
		try {
			content = URLConnectionReader.getText(URLConnectionReader.getIP()+"get_all_favourite.jsp?customerID="+Customer.getUuid());
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
